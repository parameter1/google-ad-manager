...
enum ColumnEnum {
  ...
  "All revenue earned, calculated in publisher currency, for the ads delivered by the ad server. Can correspond to any of the following in the Ad Manager UI: Ad server total revenue, Ad server CPM, CPC, CPD, and vCPM revenue. Compatible with the 'Historical' report type."
  AD_SERVER_ALL_REVENUE
  "All gross revenue earned, calculated in publisher currency, for the ads delivered by the ad server. This includes pre-rev-share revenue for Programmatic traffic. This is a temporary metric to help with the transition from gross to net revenue reporting. Can correspond to any of the following in the Ad Manager UI: Ad server total revenue (gross), Ad server CPM, CPC, CPD, and vCPM revenue (gross). Compatible with the 'Historical' report type."
  ...
  "The total CPM, CPC and CPD revenue generated by the ad servers including line item-level dynamic allocation. Can correspond to any of the following in the Ad Manager UI: Total revenue, Total CPM, CPC, CPD, and vCPM revenue. Compatible with the 'Historical' report type."
