...
type AdExchangeCreative implements HasHtmlSnippetDynamicAllocationCreativeInterface & BaseDynamicAllocationCreativeInterface & CreativeInterface {
  ...
  "The status of the ThirdPartyDataDeclaration compared with the set of third party companies detected during automated scanning. For example, if automated scanning detects more companies than have been declared, this status will be ThirdPartyDataDeclarationStatus#INCOMPLETE."
  thirdPartyDataDeclarationStatus: ThirdPartyDataDeclarationStatusEnum
  ...
  "Whether the publisher has declared that the creative contains European Union political content. Support for this field will be rolled out gradually in Q3 2025. Until then, setting this field will return an error with reason \`FeatureError.Reason#MISSING_FEATURE\`. Defaults to false for all creative types."
  selfDeclaredEuropeanUnionPoliticalContent: Boolean
...
type TemplateCreative implements CreativeInterface {
  ...
  "Whether the publisher has declared that the creative contains European Union political content. Support for this field will be rolled out gradually in Q3 2025. Until then, setting this field will return an error with reason \`FeatureError.Reason#MISSING_FEATURE\`. Defaults to false for all creative types."
  selfDeclaredEuropeanUnionPoliticalContent: Boolean
  "Creative template ID that this creative is created from. This field is required for creation and immutable."
...
"The status of the ThirdPartyDataDeclaration associated with a given creative. This is calculated by comparing the companies detected via automated scanning/parsing, with the companies declared in the ThirdPartyDataDeclaration."
enum ThirdPartyDataDeclarationStatusEnum {
  ...
  "The value returned if the actual value is not exposed by the requested API version."
  UNKNOWN
  "This entity has not been recently scanned. There is either no scanning data for this creative, or the scanning data is stale. This can happen if the creative is not associated with any line items that are active or eligible to serve."
  UNSCANNED
}
