...
type ContentLabelTargeting {
  excludedContentLabelIds: [BigInt]
}

"Content label targeting information."
input ContentLabelTargetingInput {
  excludedContentLabelIds: [BigInt]
}
...
type ConversionEvent_TrackingUrlsMapEntry {
  key: ConversionEventEnum
  value: TrackingUrls
}

"This represents an entry in a map with a key of type ConversionEvent and value of type TrackingUrls."
input ConversionEvent_TrackingUrlsMapEntryInput {
  key: ConversionEventEnum
  value: TrackingUrlsInput
}

"Describes the LineItem actions that are billable."
enum CostTypeEnum {
  "Starting February 22, 2024 the CPA CostType will be read only as part of Spotlight deprecation, [learn more](https://support.google.com/admanager/answer/7519021#spotlight). Cost per action. The LineItem#lineItemType must be one of:  LineItemType#SPONSORSHIP LineItemType#STANDARD LineItemType#BULK LineItemType#NETWORK "
  CPA
...
type GrpSettings {
  ...
  inTargetRatioEstimateMilliPercent: BigInt
...
"Represents a collection of targeted and excluded inventory sizes. This is currently only available on YieldGroup and TrafficDataRequest."
input InventorySizeTargetingInput {
  "Whether the inventory sizes should be targeted or excluded."
  isTargeted: Boolean
  "A list of TargetedSizeDtos."
  targetedSizes: [TargetedSizeInput]
}
...
"A collection of targeted inventory urls."
input InventoryUrlTargetingInput {
  targetedUrls: [InventoryUrlInput]
  excludedUrls: [InventoryUrlInput]
}
...
input ProposalLineItemInput {
  ...
  endDateTime: DateTime
  "The supply path type for this proposal line item."
  supplyPath: SupplyPathTypeEnum
...
type PublisherProvidedSignalsTargeting {
  targetedTaxonomyCategoryIds: [BigInt]
  excludedTaxonomyCategoryIds: [BigInt]
}

"Publisher provided signals targeting information."
input PublisherProvidedSignalsTargetingInput {
  targetedTaxonomyCategoryIds: [BigInt]
  excludedTaxonomyCategoryIds: [BigInt]
}
...
"Indicates how the deal's demand will be supplied."
enum SupplyPathTypeEnum {
  "The deal's demand will be supplied by a demand side platform (DSP)."
  DEMAND_SIDE_PLATFORM
  "The deal's demand will be supplied by the ad server directly."
  DIRECT
  "The value returned if the actual value is not exposed by the requested API version."
  UNKNOWN
}
...
input TargetingInput {
  ...
  "Specifies the URLs that are targeted by the entity. This is currently only supported by YieldGroup."
  inventoryUrlTargeting: InventoryUrlTargetingInput
  "Specifies the verticals that are targeted by the entity. The IDs listed here correspond to the IDs in the AD_CATEGORY table of type VERTICAL."
  verticalTargeting: VerticalTargetingInput
  "Specifies the content labels that are excluded by the entity. The IDs listed here correspond to the IDs in the CONTENT_LABEL table."
  contentLabelTargeting: ContentLabelTargetingInput
  "Specifies the sizes that are targeted by the entity. This is currently only supported on YieldGroup and TrafficDataRequest."
  inventorySizeTargeting: InventorySizeTargetingInput
  publisherProvidedSignalsTargeting: PublisherProvidedSignalsTargetingInput
}
...
enum UnitTypeEnum {
  ...
  "The number of completed views reported by creatives associated with the line item. A completed view is defined as having watched the entirety of the in-stream video ad and is only supported for standard reservation video line items. The LineItem#lineItemType must be LineItemType#STANDARD."
  COMPLETED_VIEWS
...
type VerticalTargeting {
  targetedVerticalIds: [BigInt]
  excludedVerticalIds: [BigInt]
}

"Vertical targeting information."
input VerticalTargetingInput {
  targetedVerticalIds: [BigInt]
  excludedVerticalIds: [BigInt]
}
