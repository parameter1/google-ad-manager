...
enum ColumnEnum {
  ...
  "The number of clicks an AdSense ad delivered for line item-level dynamic allocation by explicit custom criteria targeting. This metric is deprecated. Corresponds to 'AdSense targeted clicks' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ADSENSE_LINE_ITEM_LEVEL_TARGETED_CLICKS
  "The number of impressions an AdSense ad delivered for line item-level dynamic allocation by explicit custom criteria targeting. This metric is deprecated. Corresponds to 'AdSense targeted impressions' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  "The ratio of revenue to the total revenue earned from all ads delivered by AdSense for line item-level dynamic allocation. Represented as a percentage."
  ...
  "The number of clicks an Ad Exchange ad delivered for line item-level dynamic allocation by explicit custom criteria targeting. This metric is deprecated. Corresponds to 'Ad Exchange targeted clicks' in the Ad Manager UI. Compatible with the 'Historical' report type."
  AD_EXCHANGE_LINE_ITEM_LEVEL_TARGETED_CLICKS
  "The number of impressions an Ad Exchange ad delivered for line item-level dynamic allocation by explicit custom criteria targeting. This metric is deprecated. Corresponds to 'Ad Exchange targeted impressions' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  "All revenue earned, calculated in publisher currency, for the ads delivered by the ad server. Corresponds to 'Ad server total revenue' in the Ad Manager UI. Compatible with the 'Historical' report type."
  AD_SERVER_ALL_REVENUE
  "All gross revenue earned, calculated in publisher currency, for the ads delivered by the ad server. This includes pre-rev-share revenue for Programmatic traffic. This is a temporary metric to help with the transition from gross to net revenue reporting. Corresponds to 'Ad server total revenue (gross)' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  "The average estimated cost-per-thousand-impressions earned from all ads delivered by the ad server."
  ...
  "The gross revenue in the partner management. Corresponds to 'Partner management gross revenue' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_GROSS_REVENUE
  "The host clicks in the partner management. Corresponds to 'Partner management host clicks' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_HOST_CLICKS
  "The host CTR in the partner management. Corresponds to 'Partner management host CTR' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_HOST_CTR
  "The host impressions in the partner management. Corresponds to 'Partner management host impressions' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_HOST_IMPRESSIONS
  "The partner clicks in the partner management. Corresponds to 'Partner management partner clicks' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_PARTNER_CLICKS
  "The partner CTR in the partner management. Corresponds to 'Partner management partner CTR' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_PARTNER_CTR
  "The partner impressions in the partner management. Corresponds to 'Partner management partner impressions' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PARTNER_MANAGEMENT_PARTNER_IMPRESSIONS
  "The unfilled impressions in the partner management. Corresponds to 'Partner management unfilled impressions' in the Ad Manager UI. Compatible with any of the following report types: Historical, Partner finance."
  ...
  "The total CPM, CPC and CPD revenue generated by the ad servers including line item-level dynamic allocation. Corresponds to 'Total revenue' in the Ad Manager UI. Compatible with the 'Historical' report type."
...
enum DimensionEnum {
  ...
  "Breaks down reporting data by partner assignment name. PartnerAssignment name and id are automatically included as columns in the report. Corresponds to 'Partner management assignment' in the Ad Manager UI. Compatible with any of the following report types: Historical, Partner finance."
  ...
  "Breaks down reporting data by partner Company#name and Company#id are automatically included as columns in the report. Corresponds to 'Partner management partner' in the Ad Manager UI. Compatible with any of the following report types: Historical, Partner finance."
  ...
  "Breaks down reporting data by programmatic buyer name. Corresponds to 'Deal buyer' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  "Breaks down reporting data by programmatic deal ID. Corresponds to 'Deal ID' in the Ad Manager UI. Compatible with the 'Historical' report type."
  PROGRAMMATIC_DEAL_ID
  "Breaks down reporting data by programmatic deal name. Corresponds to 'Deal name' in the Ad Manager UI. Compatible with the 'Historical' report type."
