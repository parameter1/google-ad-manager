...
enum ColumnEnum {
  ...
  "Total number of impressions generated by mapped Ad Exchange properties that were eligible to measure viewability.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_ELIGIBLE_IMPRESSIONS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Active view enabled impressions' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ACTIVE_VIEW_ENABLED_IMPRESSIONS
  "The estimated percentage of impressions generated by mapped Ad Exchange properties that are eligible for Active View measurement.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_MEASURABLE_IMPRESSIONS_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Active view measurable' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Total number of eligible impressions generated by mapped Ad Exchange properties that were measurable by Active View.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_MEASURABLE_IMPRESSIONS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Active view measured impressions' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "The percentage of viewable impressions out of all measurable impressions generated by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_VIEWABLE_IMPRESSIONS_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Active view viewable' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Total number of Active View measurable impressions generated by mapped Ad Exchange properties that were viewable.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_VIEWABLE_IMPRESSIONS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Active view viewed impressions' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ACTIVE_VIEW_VIEWED_IMPRESSIONS
  "The click-through rate of impressions issued by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LINE_ITEM_LEVEL_CTR instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad CTR' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_CTR
  "Ad revenue per 1000 ad impressions, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LINE_ITEM_LEVEL_AVERAGE_ECPM instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad eCPM' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_ECPM
  "The number of ad requests issued by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_TOTAL_REQUESTS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad requests' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_REQUESTS
  "The click-through rate of ad requests issued by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_TOTAL_REQUEST_CTR instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad request CTR' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_REQUEST_CTR
  "The average estimated cost-per-thousand-ad requests earned by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_TOTAL_REQUEST_ECPM instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad request eCPM' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_REQUEST_ECPM
  "The average time (in seconds) that an individual ad impression generated by mapped Ad Exchange properties was viewable.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_ACTIVE_VIEW_AVERAGE_VIEWABLE_TIME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Average viewable time (secs)' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AVERAGE_VIEWABLE_TIME
  "The number of clicks delivered by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LINE_ITEM_LEVEL_CLICKS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Clicks' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_CLICKS
  "The coverage reported by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_MATCH_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Coverage' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_COVERAGE
  "The cost-per-click generated by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_COST_PER_CLICK instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'CPC' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_CPC
  "The matched queries click-through rate delivered by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_MATCHED_REQUEST_CTR instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'CTR' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_CTR
  "Total ad requests associated with a given Deal, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deals ad requests' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEALS_AD_REQUESTS
  "Number of responses that shows that a buyer is bidding, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deals bid responses' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEALS_BID_RESPONSES
  "Deal ad requests for mapped Ad Exchange properties which were ?matched? with demand from the buyer associated with the Deal. Each ?Deals matched request? represents one opportunity for the Deal Buyer to serve their ad in the context of the Deal.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deals matched requests' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEALS_MATCHED_REQUESTS
  "Deals matched requests divided by Deals ad requests, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deals match rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEALS_MATCH_RATE
  "The estimated net revenue generated by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LINE_ITEM_LEVEL_REVENUE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Estimated revenue' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ESTIMATED_REVENUE
  "Ad Impressions on mapped Ad Exchange properties. When multiple text ads fill a single display slot it is only counted once, when the top text ad is recognized. In these cases, the Ad Impression is attributed to the top text ad.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LINE_ITEM_LEVEL_IMPRESSIONS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad impressions' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_IMPRESSIONS
  "The total lift generated by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_LIFT_EARNINGS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Lift' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_LIFT
  ...
  "The average estimated cost-per-thousand-impressions generated by mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_MATCHED_REQUEST_ECPM instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Matched eCPM' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MATCHED_ECPM
  "Number of requests where a buyer was matched with the Ad request, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_EXCHANGE_RESPONSES_SERVED instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Matched requests' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "The video abandonment rate for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video abandonment rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_ABANDONMENT_RATE
  "Number of times that the publisher specified a video ad played automatically for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_AUTO_PLAYS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Auto-plays' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_AUTO_PLAY
  "Number of times that the publisher specified a video ad played when clicked for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_CLICK_TO_PLAYS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Click-to-plays' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_CLICK_TO_PLAY
  "Video interaction event for video ads by Ad Exchange properties. The number of times a user collapses a video, either to its original size or to a different size.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_COLLAPSE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Collapse' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_COLLAPSE
  "The number of times the video played to completion for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_COMPLETE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Complete' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_COMPLETE
  "Percentage of times the video played to the end for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_COMPLETION_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Completion rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_COMPLETION_RATE
  "The video drop off rate for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #DROPOFF_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video drop-off rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_DROPOFF_RATE
  "Video interaction event for video ads by Ad Exchange properties. The number of times a user expands a video.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_EXPAND instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Expand' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_EXPAND
  "Video interaction event for video ads by Ad Exchange properties. The number of times ad clip played in full screen mode.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_FULL_SCREEN instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Full screen' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_FULL_SCREEN
  "The number of times the video reached its midpoint during play for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_MIDPOINT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Midpoint' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_MIDPOINT
  "Video interaction event for video ads by Ad Exchange properties. The number of times video player was in mute state during play of ad clip.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_MUTE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Mute' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_MUTE
  "Video interaction event for video ads by Ad Exchange properties. The number of times user paused ad clip.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_PAUSE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Pause' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_PAUSE
  "A count of how many users watch the first 25% of a video ad, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_FIRST_QUARTILE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_VIDEO_QUARTILE_1
  "A count of how many users watch the first 75% of a video ad, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_THIRD_QUARTILE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_VIDEO_QUARTILE_3
  "Video interaction event for video ads by Ad Exchange properties. The number of times the user unpaused the video ad.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_RESUME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Resume' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_RESUME
  "Video interaction event for video ads by Ad Exchange properties. The number of times a user rewinds the video ad.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_REWIND instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Rewind' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_REWIND
  "Video interaction event for video ads by Ad Exchange properties. The number of times a skippable video is skipped.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_VIDEO_SKIPS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video skipped' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_SKIPPED
  "The number of impressions where the video was played for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_START instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video start' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_START
  "The video total error rate by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_TOTAL_ERROR_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Total error rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_TOTAL_ERROR_RATE
  "The number of times an error occurred, such as a VAST redirect error, a video playback error, or an invalid response error for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_VIEWERSHIP_TOTAL_ERROR_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Total error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_TOTAL_VAST_ERROR_COUNT
  "Percentage of times a user clicked Skip, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_TRUEVIEW_SKIP_RATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'TrueView skip rate' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_TRUEVIEW_SKIP_RATE
  "Number of times a video ad has been viewed to completion or watched to 30 seconds, whichever happens first, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_TRUEVIEW_VIEWS instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'TrueView views' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_TRUEVIEW_VIEWS
  "TrueView views divided by TrueView impressions, for mapped Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_TRUEVIEW_VTR instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'TrueView VTR' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_TRUEVIEW_VTR
  "Video interaction event for video ads by Ad Exchange properties. The number of times a user unmutes the video ad.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_INTERACTION_UNMUTE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Unmute' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_UNMUTE
  "The number of times a VAST2 error occurred for video ads by Ad Exchange properties linked to Ad Manager.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST2 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST2_ERROR_COUNT
  "The number of times a VAST3 error 100 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_100_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 100 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_100_COUNT
  "The number of times a VAST3 error 101 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_101_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 101 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_101_COUNT
  "The number of times a VAST3 error 102 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_102_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 102 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_102_COUNT
  "The number of times a VAST3 error 200 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_200_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 200 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_200_COUNT
  "The number of times a VAST3 error 201 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_201_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 201 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_201_COUNT
  "The number of times a VAST3 error 202 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_202_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 202 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_202_COUNT
  "The number of times a VAST3 error 203 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_203_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 203 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_203_COUNT
  "The number of times a VAST3 error 300 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_300_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 300 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_300_COUNT
  "The number of times a VAST3 error 301 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_301_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 301 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_301_COUNT
  "The number of times a VAST3 error 302 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_302_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 302 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_302_COUNT
  "The number of times a VAST3 error 303 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_303_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 303 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_303_COUNT
  "The number of times a VAST3 error 400 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_400_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 400 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_400_COUNT
  "The number of times a VAST3 error 401 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_401_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 401 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_401_COUNT
  "The number of times a VAST3 error 402 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_402_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 402 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_402_COUNT
  "The number of times a VAST3 error 403 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_403_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 403 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_403_COUNT
  "The number of times a VAST3 error 405 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_405_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 405 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_405_COUNT
  "The number of times a VAST3 error 500 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_500_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 500 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_500_COUNT
  "The number of times a VAST3 error 501 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_501_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 501 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_501_COUNT
  "The number of times a VAST3 error 502 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_502_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 502 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_502_COUNT
  "The number of times a VAST3 error 503 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_503_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 503 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_503_COUNT
  "The number of times a VAST3 error 600 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_600_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 600 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_600_COUNT
  "The number of times a VAST3 error 601 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_601_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 601 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_601_COUNT
  "The number of times a VAST3 error 602 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_602_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 602 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_602_COUNT
  "The number of times a VAST3 error 603 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_603_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 603 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_603_COUNT
  "The number of times a VAST3 error 604 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_604_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 604 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_604_COUNT
  "The number of times a VAST3 error 900 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_900_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 900 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_VAST_ERROR_900_COUNT
  "The number of times a VAST3 error 901 occurred for video ads by Ad Exchange properties.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_ERRORS_VAST_ERROR_901_COUNT instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'VAST3 901 error count' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
...
enum DimensionAttributeEnum {
  ...
  ADVERTISER_TYPE
  "Represents AdUnit#adUnitCode for Dimension#AD_UNIT_NAME. Corresponds to 'Ad unit code' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Ad speed."
  AD_UNIT_CODE
  "Represents the CmsContent#displayName within the first element of Content#cmsContent for Dimension#CONTENT_NAME. Corresponds to 'Content source name' in the Ad Manager UI. Compatible with the 'Historical' report type."
  CONTENT_CMS_NAME
  "Represents the CmsContent#cmsContentId within the first element of Content#cmsContent for Dimension#CONTENT_NAME. Corresponds to 'ID of the video in the content source' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  "Represents LineItem#costPerUnit for Dimension#LINE_ITEM_NAME. Corresponds to 'Rate' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_COST_PER_UNIT
  "Represents LineItem#costType for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Cost type' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_COST_TYPE
  ...
  "Represents the 3 letter currency code for Dimension#LINE_ITEM_NAME. Corresponds to 'Currency code' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  ...
  "Represents LineItem#deliveryRateType for Dimension#LINE_ITEM_NAME. Corresponds to 'Delivery pacing' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  ...
  LINE_ITEM_DISCOUNT
  "Represents the end date (in YYYY-MM-DD format) for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Line item end date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  ...
  "The total number of impressions, clicks or days that is reserved for Dimension#LINE_ITEM_NAME. Corresponds to 'Goal quantity' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  ...
  "The total number of clicks delivered over the lifetime of a Dimension#LINE_ITEM_NAME. Corresponds to 'Line item lifetime clicks' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_LIFETIME_CLICKS
  "The total number of impressions delivered over the lifetime of a Dimension#LINE_ITEM_NAME. Corresponds to 'Line item lifetime impressions' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  ...
  "Represents LineItem#priority for Dimension#LINE_ITEM_NAME as a value between 1 and 16. Can be used for filtering. Corresponds to 'Line item priority' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_PRIORITY
  ...
  "Represents the start date (in YYYY-MM-DD format) for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Line item start date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
...
enum DimensionEnum {
  "Breaks down reporting data by activity group ID. Can be used to filter by activity group ID. Compatible with the 'Historical' report type."
  ACTIVITY_GROUP_ID
  "Breaks down reporting data by activity group. The activity group name and the activity group ID are automatically included as columns in the report. Can be used to filter by activity group name. Corresponds to 'Activity group' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ACTIVITY_GROUP_NAME
  "Breaks down reporting data by activity ID. Can be used to filter by activity ID. Compatible with the 'Historical' report type."
  ACTIVITY_ID
  "Breaks down reporting data by activity. The activity name and the activity ID are automatically included as columns in the report. Can be used to filter by activity name. Corresponds to 'Activity' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ACTIVITY_NAME
  ...
  ADVERTISER_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange advertiser domain.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #ADVERTISER_DOMAIN_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Advertiser domains' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ADVERTISER_DOMAIN
  "Breaks down mapped Ad Exchange web property data by the Ad Exchange advertiser name that bids on ads.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #CLASSIFIED_ADVERTISER_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Advertisers' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ADVERTISER_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange advertiser vertical.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #ADVERTISER_VERTICAL_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Advertiser verticals' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_ADVERTISER_VERTICAL
  "Breaks down mapped Ad Exchange web property data by Ad Exchange ad location.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_LOCATION_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad locations' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_LOCATION
  "Breaks down mapped Ad Exchange web property data by Ad Exchange ad type.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_TYPE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Ad Types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AD_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange agency.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BUYING_AGENCY_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Agencies' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_AGENCY
  "Breaks down mapped Ad Exchange web property data by Ad Exchange bid type code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_BID_TYPE_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange branding type. Examples: Branded, Anonymous.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BRANDING_TYPE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Branding types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_BRANDING_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange branding type code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BRANDING_TYPE_CODE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_BRANDING_TYPE_CODE
  "Breaks down mapped Ad Exchange web property data by the Ad Exchange brand name that bids on ads.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #CLASSIFIED_BRAND_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Brands' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_BRAND_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange ad network ID.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BUYER_NETWORK_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_BUYER_NETWORK_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange ad network name. Example: Google Adwords.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BUYER_NETWORK_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Buyer networks' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_BUYER_NETWORK_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange channel.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #CHANNEL_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Channels' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_CHANNEL_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange country code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #COUNTRY_CODE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_COUNTRY_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange country name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #COUNTRY_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Countries' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_COUNTRY_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange creative size.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #CREATIVE_SIZE_DELIVERED instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Creative sizes' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_CREATIVE_SIZES
  "Breaks down mapped Ad Exchange web property data by Ad Exchange custom channel code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_CUSTOM_CHANNEL_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange custom channel ID.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_CUSTOM_CHANNEL_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange date, in Ad Exchange timezone.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #DATE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Days' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DATE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange deal id.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #PROGRAMMATIC_DEAL_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deal IDs' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEAL_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange deal name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #PROGRAMMATIC_DEAL_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Deal names' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEAL_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange device category.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #DEVICE_CATEGORY_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Device categories' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DEVICE_CATEGORY
  "Breaks down mapped Ad Exchange web property data by Ad Manager ad unit.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_UNIT_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'DFP Ad Units' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DFP_AD_UNIT
  "Breaks down mapped Ad Exchange web property data by Ad Manager ad unit ID.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #AD_UNIT_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DFP_AD_UNIT_ID
  "Breaks down mapped Ad Exchange web property data by mobile app name. Similar to the mobile app name dimension available for Historical reports.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #MOBILE_APP_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Mobile App names' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DFP_MOBILE_APP_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange DSP buyer network name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BIDDER_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'DSPs' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_DSP_BUYER_NETWORK_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange expansion type.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Expandable types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_EXPANSION_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange inventory ownership.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #INVENTORY_OWNERSHIP_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Inventory ownership' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_INVENTORY_OWNERSHIP
  "Breaks down mapped Ad Exchange web property data by Ad Exchange inventory size.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #REQUESTED_AD_SIZES instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Inventory sizes' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_INVENTORY_SIZE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange inventory size code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #REQUESTED_AD_SIZES instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_INVENTORY_SIZE_CODE
  "Breaks down mapped Ad Exchange web property data by mobile app 'resolved' id - either the app store id or '(Not applicable)' if the app is not registered in the app store. Note: app ids are not guaranteed to be unique across different app stores. Can be used for filtering.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #MOBILE_APP_RESOLVED_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Mobile App ID' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MOBILE_APP_RESOLVED_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange mobile carrier name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #CARRIER_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Carrier names' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MOBILE_CARRIER_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange mobile device name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #MOBILE_DEVICE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Devices' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MOBILE_DEVICE_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange mobile inventory type.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #MOBILE_INVENTORY_TYPE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Inventory types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MOBILE_INVENTORY_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange month, in Ad Exchange timezone.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #MONTH_AND_YEAR instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Months' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_MONTH
  "Breaks down mapped Ad Exchange web property data by Ad Exchange network partner name.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #NETWORK_PARTNER_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Network partner names' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_NETWORK_PARTNER_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange operating system version.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #OPERATING_SYSTEM_VERSION_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Operating systems' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Breaks down mapped Ad Exchange web property data by Ad Exchange pricing rule ID.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #FIRST_LOOK_PRICING_RULE_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_PRICING_RULE_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange pricing rule.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #FIRST_LOOK_PRICING_RULE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Pricing rules' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Breaks down mapped Ad Exchange web property data by Ad Exchange request source.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #DYNAMIC_ALLOCATION_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Request sources' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_REQUEST_SOURCES
  "Breaks down mapped Ad Exchange web property data by Ad Exchange site.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #SITE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Sites' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_SITE_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange tags.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_TAG_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange tag.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Tags' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_TAG_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange targeting type.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #TARGETING_TYPE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Targeting types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_TARGETING_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange targeting type code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #TARGETING_TYPE_CODE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_TARGETING_TYPE_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange deal/transaction type. Example: Open auction.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #PROGRAMMATIC_CHANNEL_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Transaction types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_TRANSACTION_TYPE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange transaction type code  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_TRANSACTION_TYPE_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange URL.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #URL_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'URLs' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_URL
  "Breaks down mapped Ad Exchange web property data by Ad Exchange URL ID.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #URL_ID instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_URL_ID
  "Breaks down mapped Ad Exchange web property data by Ad Exchange user bandwidth.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #BANDWIDTH_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Bandwidth' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_USER_BANDWIDTH_NAME
  "Breaks down mapped Ad Exchange web property data by Ad Exchange video ad duration.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_AD_DURATION instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_VIDEO_AD_DURATION
  "Breaks down mapped Ad Exchange web property data by Ad Exchange raw video ad duration.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_AD_DURATION instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video ad durations' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_AD_DURATION_RAW
  "Breaks down mapped Ad Exchange web property data by Ad Exchange video ad type.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #VIDEO_AD_TYPE_NAME instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Video ad types' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_VIDEO_AD_TYPE
  "Breaks down data by Ad Exchange mapped web property code.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #WEB_PROPERTY_CODE instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details."
  AD_EXCHANGE_WEB_PROPERTY_CODE
  "Breaks down mapped Ad Exchange web property data by Ad Exchange week, in Ad Exchange timezone.  Deprecated as part of the 'Ad Exchange Historical' to 'Historical' report type conversion. Use #WEEK instead. See <a href='https://support.google.com/admanager/answer/12104807'>Help Center</a> for more details. Corresponds to 'Weeks' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  AD_EXCHANGE_WEEK
  ...
  "Breaks down reporting data by AdUnit#id. Can be used to filter by AdUnit#id. #AD_UNIT_NAME, i.e. AdUnit#name, is automatically included as a dimension in the report. Compatible with any of the following report types: Historical, Future sell-through, Ad speed."
  AD_UNIT_ID
  "Breaks down reporting data by ad unit. AdUnit#name and AdUnit#id are automatically included as columns in the report. Can be used to filter by AdUnit#name. Corresponds to 'Ad unit' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Ad speed."
  AD_UNIT_NAME
  "Status of the ad unit. Not available as a dimension to report on, but exists as a dimension in order to filter on it using PQL. Valid values correspond to InventoryStatus. Compatible with any of the following report types: Historical, Future sell-through, Ad speed."
  AD_UNIT_STATUS
  ...
  CMS_METADATA
  "Breaks down reporting data by ContentBundle#id. Can be used to filter by ContentBundle#id. Compatible with any of the following report types: Historical, Future sell-through."
  CONTENT_BUNDLE_ID
  ...
  CONTENT_BUNDLE_NAME
  "Breaks down reporting data by Content#id. Can be used to filter by Content#id. Compatible with any of the following report types: Historical, Future sell-through."
  CONTENT_ID
  "Breaks down reporting data by content. Content#name and Content#id are automatically included as columns in the report. Can be used to filter by Content#name. Corresponds to 'Content' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through."
  CONTENT_NAME
  ...
  "Breaks down reporting data by Creative#id or creative set id (master's Creative#id) if the creative is part of a creative set. Can be used to filter by Creative#id. Compatible with any of the following report types: Historical, Ad speed."
  CREATIVE_ID
  "Breaks down reporting data by creative. Creative#name and Creative#id are automatically included as columns in the report. Can be used to filter by Creative#name. Corresponds to 'Creative' in the Ad Manager UI. Compatible with any of the following report types: Historical, Ad speed."
  CREATIVE_NAME
  ...
  "Breaks down reporting data by date in the network time zone. Can be used to filter by date using ISO 8601's format 'YYYY-MM-DD''. Corresponds to 'Date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  DATE
  ...
  DEMAND_CHANNEL_NAME
  "The ID of the device category to which an ad is being targeted. Can be used to filter by device category ID. Compatible with any of the following report types: Historical, Ad speed."
  DEVICE_CATEGORY_ID
  "The category of device (smartphone, feature phone, tablet, or desktop) to which an ad is being targeted. Can be used to filter by device category name. Corresponds to 'Device category' in the Ad Manager UI. Compatible with any of the following report types: Historical, Ad speed."
  ...
  GRP_DEMOGRAPHICS
  "Breaks down reporting data by hour of the day in the network time zone. Can be used to filter by hour of the day (from 0 to 23). Corresponds to 'Hour' in the Ad Manager UI. Compatible with the 'Historical' report type."
  HOUR
  ...
  IS_FIRST_LOOK_DEAL
  "Breaks down reporting data by LineItem#id. Can be used to filter by LineItem#id. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_ID
  ...
  LINE_ITEM_NAME
  "Breaks down reporting data by LineItem#lineItemType. Can be used to filter by line item type using LineItemType enumeration names. Corresponds to 'Line item type' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  LINE_ITEM_TYPE
  ...
  MOBILE_APP_NAME
  "Breaks down reporting data by mobile app 'resolved' id - either the app store id or '(Not applicable)' if the app is not registered in the app store. Note: app ids are not guaranteed to be unique across different app stores. Can be used for filtering. Corresponds to 'App ID' in the Ad Manager UI. Compatible with the 'Historical' report type."
  MOBILE_APP_RESOLVED_ID
  "Breaks down reporting data by device name. Can be used for filtering. Corresponds to 'Devices' in the Ad Manager UI. Compatible with the 'Historical' report type."
  MOBILE_DEVICE_NAME
  ...
  "Breaks down reporting data by month and year in the network time zone. Can be used to filter on month using ISO 4601 format 'YYYY-MM'. Corresponds to 'Month and year' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Partner finance."
  MONTH_AND_YEAR
  ...
  ORDER_NAME
  "Used to filter on all the descendants of an ad unit by AdUnit#id. Not available as a dimension to report on. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  PARENT_AD_UNIT_ID
  "Used to filter on all the descendants of an ad unit by AdUnit#name. Not available as a dimension to report on. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  PARENT_AD_UNIT_NAME
  ...
  POSITION_IN_POD
  "Breaks down reporting data by the position of the video ad within the video stream, i.e., \`UNKNOWN_POSITION\`, \`PREROLL\`, \`POSTROLL\`, \`UNKNOWN_MIDROLL\`, \`MIDROLL_1\`, \`MIDROLL_2\`, etc. \`UNKNOWN_MIDROLL\` represents a midroll, but which specific midroll is unknown. Can be used for filtering. Corresponds to 'Position of pod' in the Ad Manager UI. Compatible with the 'Historical' report type."
  POSITION_OF_POD
  ...
  "Breaks down reporting data by CustomTargetingKey#id. Compatible with the 'Historical' report type."
  VIDEO_METADATA_KEY_ID
  "Breaks down reporting data by custom targeting key. CustomTargetingKey#name and CustomTargetingKey#id are automatically included as columns in the report. Corresponds to 'Metadata key' in the Ad Manager UI. Compatible with the 'Historical' report type."
  VIDEO_METADATA_KEY_NAME
  "Breaks down reporting data by video placement. Corresponds to 'Video Placement' in the Ad Manager UI. Compatible with the 'Historical' report type."
  ...
  VIDEO_VAST_VERSION
  "Breaks down reporting data by week of the year in the network time zone. Cannot be used for filtering. Corresponds to 'Week' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach."
  WEEK
