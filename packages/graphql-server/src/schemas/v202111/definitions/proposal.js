...
type ProposalMarketplaceInfo {
  ...
  "The NegotiationRole that paused the \`Proposal\`. This field is deprecated and will always be \`null\`. Use ProposalLineItem#pauseReason instead. This attribute is read-only."
  pausedBy: NegotiationRoleEnum
  "The reason for pausing the \`Proposal\`, provided by the \`pauseRole\`. This field is deprecated and will always be \`null\`. Use ProposalLineItem#pauseReason instead. This attribute is read-only."
  pauseReason: String
