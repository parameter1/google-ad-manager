...
enum ColumnEnum {
  ...
  "The ratio of revenue generated by ad server to the total CPM, CPC and CPD revenue earned by ads delivered when no LineItem reservation could be found by the ad server for inventory-level dynamic allocation. For Ad Manager 360 networks, this includes line item-level dynamic allocation as well. Represented as a percentage. DEPRECATED - use Column.AD_SERVER_LINE_ITEM_LEVEL_WITH_CPD_PERCENT_REVENUE."
  ...
  TOTAL_FILL_RATE
  "The total CPM, CPC and CPD revenue generated by the ad servers including inventory-level dynamic allocation. DEPRECATED - use Column.TOTAL_LINE_ITEM_LEVEL_ALL_REVENUE."
  ...
  "Estimated cost-per-thousand-impressions (eCPM) of CPM, CPC and CPD ads delivered by the ad servers including inventory-level dynamic allocation. DEPRECATED - use Column.TOTAL_LINE_ITEM_LEVEL_WITH_CPD_AVERAGE_ECPM."
...
enum DimensionAttributeEnum {
  "Represents Company#creditStatus for Dimension#ADVERTISER_NAME. Can be used for filtering. Corresponds to 'Advertiser credit status' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  "Represents Company#type for Dimension#ADVERTISER_NAME. Can be used for filtering. Corresponds to 'Advertiser type' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ADVERTISER_TYPE
  "Represents AdUnit#adUnitCode for Dimension#AD_UNIT_NAME. Corresponds to 'Ad unit code' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  AD_UNIT_CODE
  ...
  "Represents LineItem#costPerUnit for Dimension#LINE_ITEM_NAME. Corresponds to 'Rate' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  LINE_ITEM_COST_PER_UNIT
  "Represents LineItem#costType for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Cost type' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  LINE_ITEM_COST_TYPE
  ...
  "Represents the 3 letter currency code for Dimension#LINE_ITEM_NAME. Corresponds to 'Currency code' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  "Represents LineItem#deliveryRateType for Dimension#LINE_ITEM_NAME. Corresponds to 'Delivery pacing' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  LINE_ITEM_DISCOUNT
  "Represents the end date (in YYYY-MM-DD format) for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Line item end date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  "The total number of impressions, clicks or days that is reserved for Dimension#LINE_ITEM_NAME. Corresponds to 'Goal quantity' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  "The total number of clicks delivered over the lifetime of a Dimension#LINE_ITEM_NAME. Corresponds to 'Line item lifetime clicks' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  LINE_ITEM_LIFETIME_CLICKS
  "The total number of impressions delivered over the lifetime of a Dimension#LINE_ITEM_NAME. Corresponds to 'Line item lifetime impressions' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  "Represents LineItem#priority for Dimension#LINE_ITEM_NAME as a value between 1 and 16. Can be used for filtering. Corresponds to 'Line item priority' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  LINE_ITEM_PRIORITY
  ...
  "Represents the start date (in YYYY-MM-DD format) for Dimension#LINE_ITEM_NAME. Can be used for filtering. Corresponds to 'Line item start date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ...
  ORDER_BOOKED_CPM
  "Represents the end date (in YYYY-MM-DD format) for Dimension#ORDER_NAME. Can be used for filtering. Corresponds to 'Order end date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ORDER_END_DATE_TIME
  ...
  ORDER_LABEL_IDS
  "The total number of clicks delivered over the lifetime of an Dimension#ORDER_NAME. Corresponds to 'Order lifetime clicks' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ORDER_LIFETIME_CLICKS
  "The total number of impressions delivered over the lifetime of an Dimension#ORDER_NAME. Corresponds to 'Order lifetime impressions' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ORDER_LIFETIME_IMPRESSIONS
  "Represents Order#poNumber for Dimension#ORDER_NAME. Can be used for filtering. Corresponds to 'Order PO number' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ORDER_PO_NUMBER
  ...
  "Represents the start date (in YYYY-MM-DD format) for Dimension#ORDER_NAME. Can be used for filtering. Corresponds to 'Order start date' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
...
enum DimensionEnum {
  ...
  "Breaks down mapped Ad Exchange web property data by mobile app name. Similar to the mobile app name dimension available for Historical reports. Corresponds to 'Mobile App names' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Breaks down mapped Ad Exchange web property data by mobile app 'resolved' id - either the app store id or '(Not applicable)' if the app is not registered in the app store. Note: app ids are not guaranteed to be unique across different app stores. Can be used for filtering. Corresponds to 'Mobile App ID' in the Ad Manager UI. Compatible with the 'Ad Exchange historical' report type."
  ...
  "Breaks down reporting data by AdUnit#id. Can be used to filter by AdUnit#id. #AD_UNIT_NAME, i.e. AdUnit#name, is automatically included as a dimension in the report. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  AD_UNIT_ID
  "Breaks down reporting data by ad unit. AdUnit#name and AdUnit#id are automatically included as columns in the report. Can be used to filter by AdUnit#name. Corresponds to 'Ad unit' in the Ad Manager UI. Compatible with any of the following report types: Historical, Future sell-through, Reach, Ad speed."
  AD_UNIT_NAME
  ...
  "Breaks down reporting data by browser criteria predefined by Ad Manager. Corresponds to 'Browser' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  BROWSER_NAME
  ...
  "Breaks down data by detected yield partner name. Corresponds to 'Yield partner (classified)' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  ...
  CUSTOM_SPOT_NAME
  "Breaks down reporting data by CustomTargetingValue#id. Can be used to filter by CustomTargetingValue#id. Compatible with any of the following report types: Historical, Reach."
  ...
  "Breaks down reporting data by top private domain. Corresponds to 'Domain' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  DOMAIN
  ...
  HOUR
  "Breaks down reporting data by inventory sharing assignment ID. Compatible with any of the following report types: Historical, Reach."
  INVENTORY_SHARE_ASSIGNMENT_ID
  "Breaks down reporting data by inventory sharing assignment name. Corresponds to 'Inventory Share Assignment' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  INVENTORY_SHARE_ASSIGNMENT_NAME
  "Breaks down reporting data by inventory sharing outcome. Corresponds to 'Inventory Share Outcome' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  INVENTORY_SHARE_OUTCOME
  "Break down the report by a boolean indicator. It's TRUE for Ad Exchange traffic fulfilled by First Look Deals. It can be used both as a dimension or dimension filter. As a filter, it can only be used with the string values 'true' and 'false'. Corresponds to 'Is First Look' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  IS_FIRST_LOOK_DEAL
  "Breaks down reporting data by LineItem#id. Can be used to filter by LineItem#id. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  LINE_ITEM_ID
  ...
  "Breaks down reporting data by Order#id. Can be used to filter by Order#id. Compatible with any of the following report types: Historical, Future sell-through, Reach, Data protection, Ad speed."
  ORDER_ID
  ...
  "Breaks down reporting data by programmatic buyer name. Corresponds to 'Programmatic buyer' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
  ...
  "Breaks down reporting data by video placement. Corresponds to 'Video Placement' in the Ad Manager UI. Compatible with any of the following report types: Historical, Reach."
