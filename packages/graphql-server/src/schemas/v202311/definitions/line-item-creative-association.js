...
input CreativePushOptionsInput {
  "The ID of the LineItem to preview. This field is required."
  lineItemId: BigInt
  "The ID of the Creative to preview. This field is required."
  creativeId: BigInt
  "The ID of the native style to preview the creative with. This field is optional but the referenced object must exist."
  nativeStyleId: BigInt
}
