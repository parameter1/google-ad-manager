...
type DaiEncodingProfile {
  ...
  "Whether to allow the creation or modification of this DaiEncodingProfile if its settings do not match one of the encoding profiles that is supported by Google DAI. Note that this field will not persist on the encoding profile itself, and will only affect the current request."
